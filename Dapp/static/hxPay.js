...
function alertNanoInstall() {
  if (window.confirm('HxExtWallet is not installed. Click "ok" to install it.')) {
    //window.open("https://wallet.hx.cash/");  //usually pop-up window is blocked
    window.location.href = 'https://wallet.hx.cash/';
  }
}
...
function showNanoInstallTip(options) {
  ...
  installBtn.onclick = function () {
    ...
    background = null;
    //window.location.href = "https://nano.hx.io/";
    window.open("https://nano.hx.io/");
  };
}
...
var createDeaultQRContainer = function (options) {
	...
	textInfo.innerHTML = 'Please use <a href= "https://nano.hx.io/" target="_blank" >NasNano</a> to scan this QR-Code.';
...
},{}],"hxpay":[function(require,module,exports){
"use strict";
